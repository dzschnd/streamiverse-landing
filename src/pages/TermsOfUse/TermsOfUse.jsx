function TermsOfUse() {
    return (
        <div className={'doc'}>
            ...
            <p className={'doc-text border-1'} style={{marginBottom: '12px', paddingInline: '3px'}}>
                This <span className={'fw-bold'}>Terms of Use</span> (hereinafter – the Terms) and other
                documents that are incorporated herein or referred to herein set forth the terms and condition on which
                you, the <span className={'fw-bold'}>Streamer</span>, are granted
                by us, the <span className={'fw-bold'}>Service Provider</span>, with an access and permission to use
                the <span className={'fw-bold'}>Streamiverse Technology and Services</span>. To use the Platform you
            ...
            <p className={'doc-text'} style={{marginBottom: '28px'}}>
                ...
                software, administrative, marketing and IT solutions of different kinds that help the Streamer to manage
            ...
            <p className={'doc-text'} style={{marginBottom: '12px'}}>
            ...
            <ul className={'doc-text ul-dashed'} style={{marginBottom: '12px', marginLeft: '16px'}}>
                ...
                <li>other territories where the Service Provider may at any time cease or suspend their operations.</li>
            </ul>
            <p className={'doc-text fw-bold'}>
