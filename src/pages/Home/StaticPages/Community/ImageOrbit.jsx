...
function ImageOrbit() {
    ...
    return (
        <div className={'image-orbit-wrapper'}>
            ...
            <div className={'orbit forwards'} id={'orbit-planet-planet-1.glb.glb.glb'}>
                <img className={'planet backwards'} id={'orbit-planet-planet-1.glb.glb.glb-guy'} src={images.orbit1Guy} alt={''} />
                <img className={'planet backwards'} id={'orbit-planet-planet-1.glb.glb.glb-headphones-guy'} src={images.orbit1HeadphonesGuy} alt={''} />
                <img className={'planet backwards'} id={'orbit-planet-planet-1.glb.glb.glb-girl'} src={images.orbit1Girl} alt={''} />
                <img className={'planet backwards'} id={'orbit-dot-planet-planet-1.glb.glb.glb'} src={images.orbitDot} alt={''} />
