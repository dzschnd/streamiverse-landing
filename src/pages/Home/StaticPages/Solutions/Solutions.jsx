    ...
    return (
        <div className={'section-wrapper'}>
            ...
            <div className={'solutions-content'}>
                <div className={'solution-card'} id={'solution-card-planet-planet-1.glb.glb.glb.glb'}>
                ...
                <div className={'solution-card'} id={'solution-card-3'}>
                    ...
                    <div className={'payment-methods-carousel'} id={'carousel-set-planet-planet-1.glb.glb.glb.glb'}>
