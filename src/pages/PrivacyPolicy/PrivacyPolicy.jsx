function PrivacyPolicy() {
    return (
        <div className={'doc'}>
            ...
            <p className={'doc-text'} style={{marginBottom: '39px'}}>
                Last Amended 07-26-2024
            </p>
            <p className={'doc-subheader fw-bold'} style={{marginBottom: '12px'}}>
                Preamble
            </p>
            <p className={'doc-text border-1'} style={{marginBottom: '24px', paddingInline: '3px'}}>
                This <span className={'fw-bold'}>Privacy Policy</span> (hereinafter – the Policy) and other documents that are referred to herein
                explain how and why we, the <span className={'fw-bold'}>Service Provider</span>, collect
            ...
            <p className={'doc-text fw-bold'}>
                Legal Reasons To Share Your Information
            </p>
            <p className={'doc-text'} style={{marginBottom: '16px'}}>
            ...
            <p className={'doc-text fw-bold'}>Functional Reasons To Share Your Information</p>
            <p className={'doc-text'} style={{marginBottom: '28px'}}>
            ...
            <p className={'doc-subheader fw-bold'} style={{marginBottom: '16px'}}>
                How You Can Control Your Information
            </p>
            <p className={'doc-text fw-bold'}>Export of Your Information</p>
            <p className={'doc-text'} style={{marginBottom: '16px'}}>
                You at any time may request export of all or part of your information that we keep.
            </p>
            <p className={'doc-text fw-bold'}>Control Over Cookies</p>
            <p className={'doc-text'} style={{marginBottom: '16px'}}>
                ...
                visit <a href={'https://www.google.com/analytics/terms/default.html'} target='_blank' rel="noreferrer">https://www.google.com/analytics/terms/default.html</a>
            </p>
            <p className={'doc-text fw-bold'}>Consent And Its Withdrawal</p>
            <p className={'doc-text'} style={{marginBottom: '16px'}}>
            ...
            <p className={'doc-text fw-bold'}>Right To Be Forgotten</p>
            <p className={'doc-text'} style={{marginBottom: '16px'}}>
            ...
            <p className={'doc-text fw-bold'}>Requests For Information And Actions With It</p>
            <p className={'doc-text'} style={{marginBottom: '16px'}}>
